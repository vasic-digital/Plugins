# Plugins - Generic, reusable Go module for plugin lifecycle management, dynamic loading, structured output parsing, and sandboxed execution.
...
challenge:
	../challenges/scripts/plugins_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Plugins - Generic, reusable Go module for plugin lifecycle management, dynamic loading, structured output parsing, and sandboxed execution."
	@echo ""
	@echo "Build & Test:"
