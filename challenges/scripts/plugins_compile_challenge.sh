#!/usr/bin/env bash
# plugins_compile_challenge.sh - Validates Plugins module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.plugins"
if grep -q "^module digital.vasic.plugins$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.plugins"
else
